...
<head>
    ...
    <script src="{{asset('//cdn.datatables.net/1.11.3/js/jquery.dataTables.min.js')}}">
         
        
    
        <link rel="{{asset('//cdn.datatables.net/1.11.3/css/jquery.dataTables.min.css')}}">
